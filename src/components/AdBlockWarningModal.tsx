      ...
      {isAdBlockActive && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 p-8 shadow-2xl shadow-black/90"
          >
            {/* Top accent line */}
            <div className="absolute inset-x-0 top-0 h-[3px] bg-[#ff9900]" />

            <div className="flex flex-col items-center text-center">
              <div className="mb-5 rounded-full bg-[#ff9900]/10 p-4 text-[#ff9900]">
                <ShieldAlert className="h-12 w-12 animate-pulse" />
              </div>

              <h2 className="mb-3 text-2xl font-black text-white tracking-tight uppercase">
                Ad Blocker Detected
              </h2>

              <p className="mb-6 text-xs text-zinc-400 leading-relaxed font-semibold">
              ...
              <button
                ...
                className="w-full rounded-xl bg-[#ff9900] py-3.5 text-xs font-black uppercase tracking-wider text-black transition-all hover:bg-[#ff9900]/95 active:scale-95 shadow-md shadow-[#ff9900]/10"
              >
